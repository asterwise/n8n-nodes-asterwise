	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						description: 'Tithi, vara, nakshatra, yoga and karana for a date and place',
			...
			},
			{
				...
				description: 'Place name; the day’s elements are taken at local sunrise there',
				displayOptions: { show: { operation: ['panchanga'] } },
